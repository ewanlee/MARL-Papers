...
## Review Papers
* [Deep Reinforcement Learning Variants of Multi-Agent Learning Algorithms](https://project-archive.inf.ed.ac.uk/msc/20162091/msc_proj.pdf) by Castaneda A O. 2016.  [`paper note`](./paper-notes/Deep%20Reinforcement%20Learning%20Variants%20of%20Multi-Agent%20Learning%20Algorithms.md)
...
### Framework
* [Mean Field Multi-Agent Reinforcement Learning](https://arxiv.org/pdf/1802.05438.pdf) by Yaodong Yang, Rui Luo, Minne Li, Ming Zhou, Weinan Zhang, and Jun Wang. arXiv, 2017. [`paper`](./paper-notes/Mean%20Field%20Multi-Agent%20Reinforcement%20Learning.md) [`code`](https://github.com/mlii/mfrl)
